...
export function analyzeMarketData(data) {
  ...
  if (bearScore <= 1) {
    ...
    allocations = [
      { name: '🤖 AI & SW (성장)', pct: 25, tickers: 'NAVER · 카카오 · 셀바스AI · 한글과컴퓨터 · 코난테크놀로지 · 솔트룩스', color: 'c1' },
      { name: '🖥️ 반도체 HBM & 소부장', pct: 20, tickers: 'SK하이닉스 · 한미반도체 · 리노공업 · 제주반도체 · 주성엔지니어링 · 가온칩스', color: 'c2' },
      { name: '🦾 로보틱스 & 물리 AI', pct: 15, tickers: '레인보우로보틱스 · 두산로보틱스 · 뉴로메카 · 에브리봇 · 티로보틱스 · 유진로봇', color: 'c3' },
      { name: '🚀 우주항공 & SMR', pct: 15, tickers: '한화에어로스페이스 · 한국항공우주 · 현대로템 · 두산에너빌리티 · 비츠로테크 · 쎄트렉아이', color: 'c4' },
      { name: '🧬 바이오 & 가상자산', pct: 15, tickers: '알테오젠 · 셀트리온 · 리가켐바이오 · 삼성바이오로직스 · 우리기술투자 · 한화투자증권', color: 'c5' },
      { name: '💰 현금·지수 ETF', pct: 10, tickers: 'KODEX 200 · TIGER 200 · KODEX 레버리지 · TIGER 차이나전기차', color: 'c7' }
    ];
  } else if (bearScore <= 3) {
    mode = 'Base';
    details = '중립장: 핵심 주도주와 에너지 전력 인프라 위주의 방어적인 성장을 동시에 추구하세요.';
    allocations = [
      { name: '🛡️ 방산 & 전력기기', pct: 25, tickers: '한화에어로스페이스 · LIG넥스원 · HD현대일렉트릭 · 효성중공업 · LS ELECTRIC · 제룡전기', color: 'c4' },
      { name: '☢️ 에너지 & 원전', pct: 20, tickers: '두산에너빌리티 · 우리기술 · 한전산업 · S-Oil · SK이노베이션 · 대한전선', color: 'c6' },
      { name: '🖥️ 반도체 & 대형주', pct: 20, tickers: '삼성전자 · SK하이닉스 · 현대차 · 기아 · POSCO홀딩스 · LG화학', color: 'c1' },
      { name: '🥇 금 & 달러 ETF', pct: 15, tickers: 'ACE KRX금현물 · TIGER 미국달러선물 · KODEX 미국달러환헤지 · TIGER 구리선물', color: 'c5' },
    ...
    allocations = [
      ...
      { name: '🛡️ 지정학 방산 & 식료품', pct: 15, tickers: '한화에어로스페이스 · LIG넥스원 · CJ제일제당 · 농심 · 삼양식품 · 오뚜기', color: 'c5' },
      { name: '🛢️ 정유 & 원자재', pct: 15, tickers: 'S-Oil · GS · SK이노베이션 · 한국가스공사 · 현대미포조선', color: 'c6' },
